...
public class InGameControllerContext extends ControllerContext {
    ...
    protected InGameControllerContext(ResourceLocation id) {
        ...
        this.chat = mappings.register(new ControllerMapping<>(new ControllerAction.Button(ControllerBoolean.Back), Side.LEFT, Component.translatable("controllerx.action.inGame.openChat"), false, "open_chat"));
